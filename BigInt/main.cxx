...
int main()
{
	...
	bigInt f2(93);
	cout<<"*** OPERATOR - TEST1 ***\n";
	cout<<"\n HERE ARE THE TWO NUMBERS I AM SUBTRACTING and setting equal to r: "<<f1<<" - "<<f2<<endl;
	r=y-z;
	cout<<"Our New r is: "<<r<<endl<<endl;
	
	cout<<"*** OPERATOR -= TEST ***\n";
	cout<<"\n Now I'm testing operator -= by saying y-=r \n";
	cout<<"r is: "<<r<<" and y is: "<<y<<endl;
	
	y-=r;
	cout<<"Our new value of y is: "<<y<<endl<<endl;
	return EXIT_SUCCESS;
}
